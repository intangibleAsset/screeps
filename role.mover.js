        	    ...
        	    if(creep.memory.transferring) {
                    ...
                    if(creep.memory.reset){
                        ...
                        if(creep.memory.step === 0 && labs[1].mineralAmount > 0){
                            if(creep.withdraw(labs[1],creep.memory.minerals[0]) === ERR_NOT_IN_RANGE){
                                creep.moveTo(labs[1]);
                            }else{
                                creep.memory.step += 1;
                            }
                        ...
                        if(creep.memory.step === 1 && labs[2].mineralAmount > 0){
                            if(creep.withdraw(labs[2],creep.memory.minerals[1]) === ERR_NOT_IN_RANGE){
                                creep.moveTo(labs[2]);
                            }else{
                                creep.memory.step += 1;
                            }
                        ...
                        if(creep.memory.step === 2 && labs[0].mineralAmount > 0){
